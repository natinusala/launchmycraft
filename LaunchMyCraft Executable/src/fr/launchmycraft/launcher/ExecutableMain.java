...
public class ExecutableMain {
	...
	//Constructeur normal
	public ExecutableMain(final long bootstrapVersion, JFrame frame, long id,  boolean hasPaid, String identifier) throws JsonSyntaxException, FileNotFoundException, IOException, URISyntaxException
	{
		...
		Platform.runLater(new Runnable()
		{
			...
			public void run() 
			{
				new Worker(bootstrapVersion).run();
			}
	...
	{		
		...
		public void run()
		{
			...
			{										
				...
				contentPane.setScene(new Scene(root));
				
				WebView view = (WebView) root.lookup("#newsWebView");
				view.getEngine().load("http://stackoverflow.com/questions/11273773/javafx-2-1-toolkit-not-initialized");
